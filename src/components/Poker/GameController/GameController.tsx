  ...
  return (
    <Grow in={true} timeout={2000}>
      <div className='GameController'>
        <Card variant='outlined' className='GameControllerCard'>
                ...
                {game.gameType !== GameType.TShirt &&
                  ...
                  game.gameType !== GameType.Custom && (
                    <>
                      ...
                      <Typography variant='subtitle1'>{t('GameController.average')}:</Typography>
                      <Typography
                        variant='subtitle1'
          ...
          <CardContent className='GameControllerCardContentArea'>
            {isModerator(game.createdById, currentPlayerId, game.isAllowMembersToManageSession) && (
              <>
                <div className='GameControllerButtonContainer'>
                  ...
                  <Typography variant='caption'>{t('Poker.gameController.reveal')}</Typography>
                </div>
                ...
                <div className='GameControllerButtonContainer'>
                  ...
                  <Typography variant='caption'>{t('Poker.gameController.restart')}</Typography>
                </div>
                ...
                <div className='GameControllerButtonContainer'>
                  ...
                  <Typography variant='caption'>{t('Poker.gameController.delete')}</Typography>
                </div>
              </>
            )}
            <div className='GameControllerButtonContainer'>
              ...
              <Typography variant='caption'>{t('Poker.gameController.exit')}</Typography>
            </div>
            <div title='Copy invite link' className='GameControllerButtonContainer'>
              ...
              <Typography variant='caption'>{t('Poker.gameController.invite')}</Typography>
            </div>
          </CardContent>
        </Card>
        <Snackbar
        ...
        >
          <Alert severity='success'>{t('Poker.gameController.inviteCopied')}</Alert>
        </Snackbar>
      </div>
    </Grow>
  );
