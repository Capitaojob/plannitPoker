...
export const deckCards: CardConfig[] = [
  { value: 0, displayValue: '4', color: '#A3DFF2' },
  { value: 1, displayValue: '5', color: '#9DD49A' },
  { value: 2, displayValue: '6', color: '#9DD49A' },
  { value: 3, displayValue: '7', color: '#F4DD94' },
  { value: 5, displayValue: 'J', color: '#F4DD94' },
  { value: 8, displayValue: 'Q', color: '#F39893' },
  { value: 13, displayValue: 'K', color: '#F39893' },
  { value: 21, displayValue: 'A', color: '#9EC8FE' },
  { value: 34, displayValue: '2', color: '#9EC8FE' },
  { value: 55, displayValue: '3', color: '#A3DFF2' },
  { value: -2, displayValue: '❓', color: 'var(--color-background-secondary)' },
  { value: -1, displayValue: '-1', color: 'var(--color-background-secondary)' },
];
